...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out_affine_1, cache_affine_1 = affine_forward(X, W1, b1)
        out_relu_2, cache_relu_2 = relu_forward(out_affine_1)
        scores, cache_affine_2 = affine_forward(out_relu_2, W2, b2)
        ...
        d_affine_2, dW2, db2 = affine_backward(dloss, cache_affine_2)
        dx, dW1, db1 = affine_relu_backward(d_affine_2,
                                            (cache_affine_1, cache_relu_2))
